...
class SteeringActionClient(Node):
    ...
    def __init__(self):
        super().__init__('move_arm_actionclient')
        self._action_client = ActionClient(self, FollowJointTrajectory, '/joint_garra_ombro/Controller')

    def send_goal(self, position_value):
        goal_msg = FollowJointTrajectory.Goal()

        # Fill in data for trajectory
        joint_names = ["joint_garra_ombro"]
